...
/// <summary>
/// Service implementation for FizzBuzz operations.
/// </summary>
public class FizzBuzzService : IFizzBuzzService
{
    ...
    /// Example: 36 with all rules → "FizzFuzzJazz"
    /// </summary>
    ...
    /// <param name="includeFuzz">Whether to include Fuzz rule (divisible by 4)</param>
    /// <param name="includeJazz">Whether to include Jazz rule (divisible by 9)</param>
    /// <returns>FizzBuzz string representation</returns>
